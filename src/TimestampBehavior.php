...
class TimestampBehavior extends Behavior
{
    ...
    {
        $excludeParams = $this->parameters['exclude'];
        $exclude = "
...
";
        ...
        if ($this->withUpdatedAt()) {
            return $exclude . "if (\$this->isModified() && !\$this->isColumnModified(" . $this->getColumnConstant('update_column', $builder) . ") && !\$onlyExcludeParams) {
